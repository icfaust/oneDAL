...
/// Tag-type that parameterizes entities that are used to compute the split.
struct compute {};
...
public:
    ...
    /// @remark default = -1.0
    double get_train_size() const {
        return base_t::get_train_size();
    }

    auto& set_train_size(double value) {
        base_t::set_train_size(value);
        return *this;
    }

    /// @remark default = 0.25 (when neither are set)
    double get_test_size() const {
        return base_t::get_test_size();
    }

    auto& set_test_size(double value) {
        base_t::set_test_size(value);
        return *this;
    }

    /// @remark default = true
    bool get_shuffle() const {
        return base_t::get_shuffle();
    }
    ...
    auto& set_seed(std::uint64_t value) {
